...
<template>
  <div class="space-y-10">
    ...
    <section>
      ...
      <div class="space-y-5">
        <div v-for="(edu, i) in education" :key="i" class="relative flex flex-col sm:flex-row gap-0.5 sm:gap-4 text-sm">
    ...
    <section>
      ...
      <div class="space-y-5">
        <div v-for="(exp, i) in experience" :key="i" class="relative flex flex-col sm:flex-row gap-0.5 sm:gap-4 text-sm">
    ...
    <section id="grants">
      ...
      <ul class="space-y-4">
        <li v-for="(grant, i) in grants" :key="i" class="relative flex gap-1 text-sm">
    ...
    <section id="awards">
      ...
      <ul class="space-y-4">
        <li v-for="(award, i) in awards" :key="i" class="relative flex gap-1 text-sm">
          <span class="text-gray-300 dark:text-zinc-600 shrink-0 mt-0.5 select-none">–</span>
          <div
            class="min-w-0 flex-1"
            :class="!wrap ? 'overflow-x-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden' : ''"
